...
import { ExportType } from "@/functions/http-client/api/all";
...
export type FileAlreadyExistsError = BadRequestException<"FILE_ALREADY_EXISTS", string>
export type BuiltinNotWritableError = BadRequestException<"BUILTIN_NOT_WRITABLE", string>
