...
export function createSourceTagMappingEndpoint(http: HttpInstance): SourceTagMappingEndpoint {
    return {
        ...
        batchQueryByIllusts: http.createDataRequest("/api/source-tag-mappings/batch-query-by-illusts", "POST"),
...
export interface SourceTagMappingEndpoint {
     ...
     * 根据给出的tags，查询这些tags的所有能映射到的source tags。
     */
    batchQueryByIllusts(illustIds: number[]): Promise<Response<BatchQueryResult[]>>
    /**
