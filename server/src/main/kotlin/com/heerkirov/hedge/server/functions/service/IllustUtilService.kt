...
class IllustUtilService(private val data: DataRepository) {
    ...
    fun getImageSituation(illustIds: List<Int>): List<ImageSituationRes> {
        data class Row(val id: Int, val type: IllustModelType, val parentId: Int?, val childrenCount: Int?, val orderTime: LocalDateTime, val thumbnailFile: String)
    ...
    fun getBookSituation(illustIds: List<Int>, bookId: Int, onlyExists: Boolean): List<BookSituationRes> {
        data class Row(val id: Int, val type: IllustModelType, val thumbnailFile: String)
