...
object Tags : MetaTagTable<Tag>("tag", schema = "meta_db") {
    ...
    val isSequenceGroup = boolean("is_sequence_group")
    val isOverrideGroup = boolean("is_override_group")
    ...
    override fun doCreateEntity(row: QueryRowSet, withReferences: Boolean) = Tag(
        ...
        type = row[type]!!,
        isSequenceGroup = row[isSequenceGroup]!!,
        isOverrideGroup = row[isOverrideGroup]!!,
